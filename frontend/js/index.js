...
const fetchClients = async (data, servico) => {
    const response = await fetch('https://kelly-dias-full-stack-git-master-miqueiasfrancos-projects.vercel.app//clients')
    ...
    if (datasAgendadas.includes(data)) {
        ...
        await fetch('https://kelly-dias-full-stack-git-master-miqueiasfrancos-projects.vercel.app//clients', {
            method:'post',
